...
<span class="add">The class *exprloc* is used to provide a location
...
<span class="add">The piece operations (`DW_OP_piece` and `DW_OP_bit_piece`) in this
